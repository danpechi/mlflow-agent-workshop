...
# MAGIC All other notebooks (`02b_tracing` through `02e`) `%run` this notebook to inherit:
# MAGIC
...
# MAGIC
# MAGIC > **Note:** This notebook does NOT deploy the Databricks App. Use `02a_setup_and_agent` or `02f_redeploy_app` for that.
...
# MAGIC
# MAGIC This cell is **idempotent** — if V1 is already registered, it just ensures the alias exists.
...
# Register V1 in the Prompt Registry (idempotent -- safe to re-run)
